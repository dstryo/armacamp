...
export default function Model2(props) {
  ...
  const [ref] = useBox(() => ({ mass: 0, position: [0, 0, 20], args: [2, 2, 2] }))
  return (
    <group {...props} dispose={null} scale={[1.5, 1.5, 1.5]} position={[0, -0.3, -10]}>
      <group position={[-0.036, 0.174, -1.632]} ref={ref}>
